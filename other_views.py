...
def home():
    ...
    num_completed = Response.query.filter_by(response_panelist_id=current_user.panelist_id).group_by(Response.parent_survey_id).count() # count the number of unique survey_ids in that panelists responses table.
